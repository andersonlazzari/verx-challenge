...
.AllowAnonymous() // Permite acessar sem estar logado (obviamente!)
.WithTags("Autenticacao");

using (var scope = app.Services.CreateScope())
{
    var dbContext = scope.ServiceProvider.GetRequiredService<Consolidado.Worker.Data.ConsolidadoDbContext>();
